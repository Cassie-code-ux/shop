...
public class CartView extends CartEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		//级联表 goods
			...
			* 商品 的 商家
			*/
			private Integer goodsShangjiaId;
			/**
			* 商品名称
			*/
		...
		try {
			...
			e.printStackTrace();
				...
				//级联表的get和set goods
					...
					* 获取：商品 的 商家
					*/
					public Integer getGoodsShangjiaId() {
						return goodsShangjiaId;
					}
					/**
					* 设置：商品 的 商家
					*/
					public void setGoodsShangjiaId(Integer goodsShangjiaId) {
						this.goodsShangjiaId = goodsShangjiaId;
					}
